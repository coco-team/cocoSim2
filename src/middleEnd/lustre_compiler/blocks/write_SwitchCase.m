...
%% Code
%
function [output_string, var_out] = write_SwitchCase(block, ir_struct, varargin)

var_out = {};

cond = LusUtils.getParamValue(ir_struct, block, block.CaseConditions);
default_case = block.ShowDefaultCase;
