...
block_param_map('DiscreteFilter') = {'Numerator', 'Denominator',...
    'a0EqualsOne', 'InitialStates', 'OutMin', 'OutMax'};
...
block_param_map('MultiPortSwitch') = {'DataPortOrder', 'DataPortIndices'...
    'Inputs', 'DataPortForDefault', 'AllowDiffInputSizes' 'RndMeth', ...
    'SaturateOnIntegerOverflow', 'OutMin', 'OutMax'};
block_param_map('ManualSwitch') = {'sw'};
block_param_map('Scope') = {'Floating'};

block_param_map('Outport') = {'Port', 'CompiledPortDimensions', ...
    'CompiledPortDataTypes', 'UseBusObject', 'BusObject', ...
    'OutputWhenDisabled', 'InitialOutput', 'OutMin', 'OutMax'};

block_param_map('Inport') = {'Port', 'CompiledPortDimensions', ...
    'CompiledPortDataTypes', 'UseBusObject', 'BusObject', ...
    'OutMin', 'OutMax'};
...
block_param_map('TriggerPort') = {'ShowOutputPort', 'TriggerType', ...
    'OutMin', 'OutMax', 'StatesWhenEnabling'};
